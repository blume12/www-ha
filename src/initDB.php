...
$sql = "CREATE TABLE IF NOT EXISTS program (PId INTEGER PRIMARY KEY, BUId VARCHAR, author VARCHAR(255), 
        countTickets INTEGER, 'date' TEXT, title VARCHAR(255), text TEXT) ";
$dbqObject->query($sql);
...
$sql = "CREATE TABLE IF NOT EXISTS reservation (RId INTEGER PRIMARY KEY, reservationNumber VARCHAR(50), firstname VARCHAR(255),
        lastname VARCHAR(255), email VARCHAR(255), createDate VARCHAR(255), status VARCHAR(10), text TEXT) ";
$dbqObject->query($sql);
